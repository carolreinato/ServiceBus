...
namespace ServiceBus
{
    class Program
    {
        const string QueueConnectionString = "Endpoint=sb://geekburgercaroline.servicebus.windows.net/;SharedAccessKeyName=ProductPolicy;SharedAccessKey=5Kck54yNm1km/ho7Ncc/pz1VQpbYV7Mrm0gm0FpJzxM=";
